...
ALTER TABLE public.car_model_id_seq OWNER TO ivan;
...
ALTER TABLE public.race_id_seq OWNER TO ivan;
...
ALTER TABLE public.user_car_id_seq OWNER TO ivan;
...
ALTER TABLE public.user_car_vinyl_id_seq OWNER TO ivan;
...
ALTER TABLE public.vinyl_id_seq OWNER TO ivan;
...
1	Sanek	100	0	0	Shadruhin	5	2200	0	0	0	0	\N	SSH52	7	0	1	0	USER
4	Tox1n	100	0	0		0	444000	0	0	0	556023311	\N	tox1n71	0	0	5	0	USER
\.
...
SELECT pg_catalog.setval('public.race_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.user_car_id_seq', 5, true);
