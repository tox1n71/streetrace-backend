...
//
//    public String extractTelegramId(String jwtToken) {
...
//    }
//
//    public String generateToken(Map<String, Object> extraClaims, Long telegramId) {
//        return Jwts.builder()
...
//        String telegramId = extractTelegramId(token);
//        return (telegramId.equals(((User) userDetails).getTelegramId().toString()) && !isTokenExpired(token));
//    }
//
